		...
		<nav class="navbar navbar-expand-md bg-dark navbar-dark">
			...
			<div class="collapse navbar-collapse" id="collapsibleNavbar">
				<ul class="navbar-nav ml-auto">	
					...
					<li class="nav-item active"><a class="nav-link" href="track.php"><b>Track Order</b></a></li>
								...
								<table class="table table-bordered table-hover  "  >
									...
									<tbody>								
										<tr>
											...
											<td><center><a href="action.php?removed=<?= $row['id'] ?>" class="text-danger lead" onclick="return confirm('Are you sure you want to delete this order?');"><i class="fa fa-trash-o" style="font-size:23px"></i></a></td>	
										</tr>
